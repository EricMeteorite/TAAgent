...
3. Run: exec(open(r"D:/CodeBuddy/rendering-mcp/unreal/agent-harness/ue_cli_listener_auto.py").read())
4. Run: start_ue_cli()
...
LISTENER_FILE = Path(r"D:/CodeBuddy/rendering-mcp/unreal/agent-harness/ue_cli_listener.py")
